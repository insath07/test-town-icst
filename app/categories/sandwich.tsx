...
export default function SandwichPage() {
  ...
  const sandwiches = [
    { name: 'Grilled Cheese Sandwich', price: 300, stock: 12, image: require('@/assets/images/Sandwich.jpeg') },
    { name: 'Chicken Sandwich', price: 450, stock: 8, image: require('@/assets/images/Sandwich.jpeg') },
    { name: 'Veg Sandwich', price: 280, stock: 15, image: require('@/assets/images/Sandwich.jpeg') },
  ];

  const [quantities, setQuantities] = useState(sandwiches.map(() => 1));
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {sandwiches.map((item, idx) => (
          <ThemedView key={idx} style={styles.card}>
            <Image source={item.image} style={styles.sandwichImage} />
