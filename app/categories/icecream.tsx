...
export default function IceCreamPage() {
  ...
  const icecreams = [
    { name: 'Vanilla Ice Cream', price: 150, stock: 20, image: require('@/assets/images/Icecream.jpeg') },
    { name: 'Chocolate Ice Cream', price: 180, stock: 15, image: require('@/assets/images/Icecream.jpeg') },
    { name: 'Strawberry Ice Cream', price: 170, stock: 18, image: require('@/assets/images/Icecream.jpeg') },
  ];
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {icecreams.map((item, idx) => (
          <ThemedView key={idx} style={styles.card}>
            <Image source={item.image} style={styles.iceImage} />
...
const styles = StyleSheet.create({
  ...
  itemName: { color: '#fff', fontSize: 18, fontWeight: '600', marginBottom: 4 },
  itemPrice: { color: '#ff6347', fontSize: 16, fontWeight: 'bold' },
